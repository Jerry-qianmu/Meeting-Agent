...
class RAGconfig:
    ...
    # chunk merge
    chunk_merge_enable: bool = settings.chunk_merge_enable
    chunk_merge_max_tokens: int = settings.chunk_merge_max_tokens
    chunk_merge_max_gap: int = settings.chunk_merge_max_gap
    chunk_merge_enable_context_expansion: bool = settings.chunk_merge_enable_context_expansion
    chunk_merge_min_tokens_for_expansion: int = settings.chunk_merge_min_tokens_for_expansion
    chunk_merge_enable_second_rerank: bool = settings.chunk_merge_enable_second_rerank
    chunk_merge_second_rerank_limit: int = settings.chunk_merge_second_rerank_limit
    chunk_merge_final_top_k: int = settings.chunk_merge_final_top_k
