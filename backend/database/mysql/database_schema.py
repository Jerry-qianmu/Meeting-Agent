...
CREATE TABLE IF NOT EXISTS chunk (
    ...
    description TEXT DEFAULT NULL COMMENT 'chunk 摘要描述（LLM 生成）',
    keywords JSON DEFAULT NULL COMMENT '关键词列表（LLM 生成）',
    heading_path JSON DEFAULT NULL COMMENT '标题路径（如 ["# H1", "## H2", "### H3"]）',
    metadata JSON DEFAULT NULL COMMENT '扩展元数据',
...
# 导入 Memory Constellations 记忆系统 DDL
try:
    from memory_schema import MEMORY_DDL_STATEMENTS
    ALL_DDL_STATEMENTS.extend(MEMORY_DDL_STATEMENTS)
except ImportError:
    pass
